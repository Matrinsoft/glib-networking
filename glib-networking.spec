...
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.90~alpha-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 29 2026 Milan Crha <mcrha@redhat.com> - 2.90~alpha-1
- Update to 2.90.alpha

* Mon Apr 27 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 2.80.1-9
- Add Supplements: glib2

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 2.80.1-8
- Add configuration for release-monitoring

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 2.80.1-7
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 2.80.1-6
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 2.80.1-5
- Onboard to Packit for stable Fedora branches

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.80.1-4
